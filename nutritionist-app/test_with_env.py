#!/usr/bin/env python3
"""
Qwen-VL API 測試（使用環境變數中的 API Key）
"""
...
if not API_KEY:
    print("❌ 錯誤：找不到環境變數 ALIYUN_API_KEY")
    print("\n請到 OpenClaw 配置文件中查看，或者手動設置：")
    print("export ALIYUN_API_KEY=sk-xxxxx")
    sys.exit(1)
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("用法：python3 test_with_env.py <圖片路徑>")
        sys.exit(1)
